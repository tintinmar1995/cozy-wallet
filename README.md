[![Travis build status shield](https://img.shields.io/travis/tintinmar1995/cozy-wallet/master.svg)](https://travis-ci.org/tintinmar1995/cozy-wallet)
[![Github Release version shield](https://img.shields.io/github/tag/tintinmar1995/cozy-wallet.svg)](https://github.com/tintinmar1995/cozy-wallet/releases)
...
Hacking the Cozy Cozy Wallet app requires you to [setup a dev environment][setup].

You can then clone the app repository and install dependencies:

```sh
$ git clone https://github.com/tintinmar1995/cozy-wallet.git
$ cd cozy-wallet
$ yarn install
```
...
After the build and the stack launched, your app is now available at http://cozy-wallet.cozy.tools:8080.
...
If you want to work on Cozy Wallet and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
The lead maintainer for Cozy Wallet is [tintinmar1995](https://github.com/tintinmar1995), send him/her a :beers: to say hello!
...
Cozy Wallet is developed by tintinmar1995 and distributed under the [AGPL v3 license][agpl-3.0].
